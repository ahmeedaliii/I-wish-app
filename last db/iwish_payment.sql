...
CREATE TABLE `payment` (
  ...
  KEY `amountPaid_idx` (`amountPaid`),
  CONSTRAINT `amountPaid_1` FOREIGN KEY (`amountPaid`) REFERENCES `contributions` (`friendEmail`),
  CONSTRAINT `wallet_1` FOREIGN KEY (`wallet`) REFERENCES `users` (`email`)
