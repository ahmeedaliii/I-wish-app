...
CREATE TABLE `owneditems` (
  ...
  CONSTRAINT `ownedItems_itemID1` FOREIGN KEY (`itemID`) REFERENCES `items` (`itemID`),
  CONSTRAINT `ownedItems_userEmail` FOREIGN KEY (`userEmail`) REFERENCES `users` (`email`)
